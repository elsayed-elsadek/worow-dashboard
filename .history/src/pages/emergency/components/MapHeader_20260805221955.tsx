      ...
      <div className="flex flex-wrap items-center justify-between gap-3">
        <div className="flex flex-wrap items-center gap-2">
          ...
          <button
            ...
            className="flex items-center cursor-pointer gap-2 rounded-full px-3 py-2 text-sm font-medium text-white transition bg-[#1E40AF]/20 border border-white/10 hover:opacity-90"
