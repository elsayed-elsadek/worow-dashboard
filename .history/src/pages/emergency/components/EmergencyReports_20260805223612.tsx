    ...
    <aside className="w-full space-y-4  border border-gray-500 border-l-white bg-[#231016]/95 p-3 text-white font-sans dir-rtl"
     style={{ background: theme.secondary }}>
      ...
      <div className="space-y-2 pt-2">
        <button
          type="button"
          className="flex w-full items-center justify-center gap-2 rounded-xl border border-white/20 bg-[#FF4242]/20 py-2.5 text-sm font-bold text-white shadow-md transition hover:bg-[#7f2730]"
        >
      ...
      <div className="space-y-2">
        ...
        <div className="space-y-2">
          <button
            type="button"
            className="flex w-full items-center justify-center gap-2 rounded-lg border border-white/10 bg-[#FF4242]/20 py-2 text-xs font-bold text-white transition hover:bg-[#7a2a33]"
          >
<span>{t('emergency.tagSelected', 'تشنج / غياب وعي')}</span>
          ...
          <button
            type="button"
            className="flex w-full items-center justify-center gap-2 rounded-lg border border-white/10 bg-[#F59E0B]/20 py-2 text-xs font-bold text-white transition hover:bg-[#6b4323]"
          >
          ...
          <button
            type="button"
            className="flex w-full items-center justify-center gap-2 rounded-lg border border-white/10 bg-[#16A34A]/20 py-2 text-xs font-bold text-white transition hover:bg-[#36573c]"
          >
