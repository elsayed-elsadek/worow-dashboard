    ...
    >
     ...
     style={{ background: theme.section }}
      ...
      <div className="space-y-3 pt-1">
        ...
        <button
          type="button"
          className="flex w-full items-center justify-center gap-2 rounded-lg border border-white/10 bg-[#EAB308] py-3 text-base font-bold text-white transition hover:bg-[#6e4623]"
        >
