     ...
     style={{ background: theme.secondary }}>
      ...
      <div className="space-y-2">
        ...
        <div className="space-y-2">
          ...
          <button
            type="button"
            className="flex w-full items-center justify-center gap-2 rounded-lg border border-white/10 bg-[#16A34A] py-2 text-xs font-bold text-white transition hover:bg-[#36573c]"
          >
