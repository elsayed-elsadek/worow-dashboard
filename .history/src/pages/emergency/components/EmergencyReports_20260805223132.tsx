     ...
     style={{ background: theme.secondary }}>
      ...
      <div className="space-y-2">
        ...
        <div className="space-y-2">
          <button
            type="button"
            className="flex w-full items-center justify-center gap-2 rounded-lg border border-white/10 bg-[#FF4242] py-2 text-xs font-bold text-white transition hover:bg-[#7a2a33]"
          >
