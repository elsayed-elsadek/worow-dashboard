  ...
  <span>الموافقة بالذكاء الاصطناعي</span>
        ...
        <div className="relative" ref={dropdownRef}>
          <button
            ...
            className={`flex items-center justify-center gap-2 rounded-full border px-4 py-2 text-sm font-medium text-[#38C2DD] transition ${
              selectedRegion
          ...
          >
            <MapPin size={16} className={selectedRegion ? 'text-emerald-400' : 'text-38C2DD/70'} />
