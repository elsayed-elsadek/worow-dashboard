...
<button className="relative flex items-center justify-center rounded-full border border-white/20 bg-white/10 py-2 pl-5 pr-10 text-sm font-medium text-white transition hover:bg-white/20 active:scale-95">
  <div className="absolute -right-2 -top-1.5 flex h-9 w-9 items-center justify-center rounded-full border border-white/30 bg-[#07292C] text-[#38C2DD] shadow-lg">
    <Bot size={20} />
  </div>
  ...
  <span>الموافقة بالذكاء الاصطناعي</span>
        ...
        <div className="relative" ref={dropdownRef}>
          ...
          >
            <MapPin size={16} className={selectedRegion ? 'text-emerald-400' : 'text-white/70'} />
