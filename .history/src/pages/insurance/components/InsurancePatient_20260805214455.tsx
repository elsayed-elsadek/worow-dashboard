...
<Info size={15} className="text-white shrink-0" />
            ...
            <button className="flex items-center gap-1.5 rounded-full border border-white/15 bg-[#22C55E]/10 px-3.5 py-2 text-xs font-semibold text-white transition hover:bg-white/20 active:scale-95">
