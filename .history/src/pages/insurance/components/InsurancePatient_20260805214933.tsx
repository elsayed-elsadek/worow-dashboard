      ...
      <div className="flex flex-col gap-4 lg:flex-row lg:items-center lg:justify-between">
        ...
        <div className="flex flex-col gap-4 sm:flex-row sm:items-center">
          ...
          <div className="flex flex-wrap items-center gap-2.5 sm:mr-4 border-t border-white/10 pt-3 sm:border-t-0 sm:pt-0 sm:border-r sm:border-white/10 sm:pr-4">
            <button className="flex items-s gap-1.5 rounded-full border border-white/15 bg-[#6B7280]/10 px-3.5 py-2 text-xs font-semibold text-white transition hover:bg-white/20 active:scale-95">
