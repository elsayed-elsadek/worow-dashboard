...
<button className="relative flex items-center justify-center rounded-full border border-white/20 bg-[#]/10 py-2 pl-5 pr-10 text-sm font-medium text-[#38C2DD] transition hover:bg-white/20 active:scale-95">
