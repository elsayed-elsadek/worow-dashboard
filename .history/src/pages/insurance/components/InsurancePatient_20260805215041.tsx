      ...
      <div className="flex flex-col gap-4 lg:flex-row lg:items-center lg:justify-between">
        ...
        <div className="flex flex-col gap-4 sm:flex-row sm:items-center">
          ...
          <div className="flex flex-wrap items-center gap-2.5 sm:mr-4 border-t border-white/10 pt-3 sm:border-t-0 sm:pt-0 sm:border-r sm:border-white/10 sm:pr-4">
            <button className="flex place-items-end gap-1.5 rounded-full border border-white/15 bg-[#6B7280]/10 px-3.5 py-2 text-xs font-semibold text-white transition hover:bg-white/20 active:scale-95">
<Info size={15} className="text-white shrink-0" />
              <span className="leading-none ">تفاصيل الحالة</span>
            </button>

            <button className="flex  place-items-end gap-1.5 rounded-full border border-white/15 bg-[#22C55E]/20 px-3.5 py-2 text-xs font-semibold text-white transition hover:bg-white/20 active:scale-95">
              <ShieldCheck size={15} className="text-white shrink-0" />
              <span className="leading-none">تفاصيل التأمين</span>
            </button>

            <button className="flex  place-items-end gap-1.5 rounded-full border border-white/15 bg-[#3B82F6]/20 px-3.5 py-2 text-xs font-semibold text-white transition hover:bg-white/20 active:scale-95">
        ...
        <div className="flex items-center justify-between gap-3 border-t border-white/10 pt-3 lg:border-t-0 lg:pt-0 lg:justify-end">
          {isAlert ? (
            <div className="flex items-center gap-3 w-full lg:w-auto justify-between lg:justify-end">
              ...
              <button className="flex items-center gap-2 rounded-full bg-[#FFA442]/40 px-4 py-2 text-sm font-bold text-white shadow-sm shadow-[#d97706]/30 transition  active:scale-95">
            ...
            <div className="flex items-center gap-4 w-full lg:w-auto justify-between lg:justify-end">
              ...
              <button className="flex items-center gap-2 rounded-full bg-[#FFA442]/40 px-4.5 py-2 text-sm font-bold text-white shadow-sm shadow-[#d97706]/30 transition  active:scale-95">
                <CalendarDays size={16} />
                حجز موعد
              </button>
            </div>
